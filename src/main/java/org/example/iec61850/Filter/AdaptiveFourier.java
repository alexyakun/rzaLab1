...
public class AdaptiveFourier extends Filter{
    ...
    public AdaptiveFourier(int buffsize, double freq) {
    ...
    public void process(MV inValue, CMV outValue) {
        this.buffSize.setValue((int) Math.round (1 / (this.step.getValue() * freq.getValue())));
//        System.out.println(this.buffSize.getValue());
