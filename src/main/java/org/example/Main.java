...
//import org.example.iec61850.lodicalNodes.protocol.MyPacketListener;
//
...
//        lsvs.setNicName("Realtek PCle GbE Family Controller");
//        MMXU mmxu = new MMXU();
...
////            System.out.println();
////        }
//        lsvs.addListener(() -> logicalNode.forEach(LN::process));
//        lsvs.process();
//    }
//
//}
